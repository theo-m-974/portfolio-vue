  ...
  <div id="projects" class="projects">
    ...
    <div class="projects-template">
      <div
        ...
        "
      >
        <img :src="currentType[index].imgs[0]" :alt="currentType[index].alt" />
    ...
    <div class="project-modale" :class="modaleIsDisplayed ? 'displayed' : ''">
      ...
      <div class="project-info--grid">
        <div class="project-brief">
          ...
          <div class="project-brief-content">{{ selectedProject.date }}</div>
        </div>
        <div class="project-brief">
          <div class="project-brief-header">Type</div>
          <div class="project-brief-content">{{ selectedProject.type }}</div>
        </div>
        <div class="project-brief">
      ...
      >
        <div
          ...
          class="project-image"
        >
          <img :src="selectedProject.imgs[image]" :alt="selectedProject.alt" />
        </div>
      </div>
    </div>
  </div>
